...
/**
 * Bulk / B2B enquiry form, used on the Bulk | B2B page.
 *
 * Deliberately without the "Who are you?" / "What are you looking for?"
 * qualifiers that EnquiryForm carries: anyone filling this in has already
 * self-selected as a trade enquiry by navigating here, and the Company field
 * covers most of what the role question would tell us.
 *
